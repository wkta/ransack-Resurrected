    ...
    def generateMap(self, orientation):
            ...
            for x in range(0, self.generalmap.getDIM()):
                ...
                for y in range(1, self.generalmap.getDIM() / 2):
                    if x == 0 or x == self.generalmap.getDIM() - 1:
                        ...
                        self.generalmap.setEntry(x, y, misc.weightedChoice(mapScr.wildsTilesList))
            ...
            for x in range(0, self.generalmap.getDIM()):
                ...
                for y in range(1, self.generalmap.getDIM() / 2):
                    if x == 0 or x == self.generalmap.getDIM() - 1:
                        ...
                        self.generalmap.setEntry(y, x, misc.weightedChoice(mapScr.wildsTilesList))
        ...
        while i < 5:
            ...
            if misc.rollDie(0, 2):
                ...
                chestItems.append((randrange(31, 34), self.level / 4, randrange(0, 3)))
    ...
    def draw(self):
        ...
        for i in range(self.generalmap.getDIM()):
            for j in range(self.generalmap.getDIM()):
                gridField.blit(images.mapImages[self.generalmap.getEntry(i, j)],
                               (i * const.blocksize, j * const.blocksize))
