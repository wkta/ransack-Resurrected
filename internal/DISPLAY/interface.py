...
class Interface:
    ...
    def npcDialog(self, message, img=None):
        ...
        buttons = [button.Button(
            ((self.screen.get_width() / 2 - borderBox.get_width() / 2) + int(ceil(50 * const.scaleFactor)),
             150 + msgText.get_height()),
            'Yes'),
                   button.Button(((self.screen.get_width() / 2 - borderBox.get_width() / 2) + int(
                       ceil(50 * const.scaleFactor)) + (borderBox.get_width() - 200),
                                  150 + msgText.get_height()),
                                 'No')
                   ]
        for i in range(0, 255, 8):
