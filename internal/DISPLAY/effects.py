...
class effects:
    def __init__(self, clock, screen):
        ...
        self.flashDict = {pygame.K_c: (
        int(floor(173 * const.scaleFactor)), int(ceil(106 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # upper left   (7) cast spell
                          pygame.K_LEFT: (int(floor(173 * const.scaleFactor)),
                                          int(ceil(143 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # middle left  (4) left
                          pygame.K_m: (int(floor(173 * const.scaleFactor)),
                                       1 + int(ceil(180 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # lower left   (1) map *
                          pygame.K_UP: (int(floor(210 * const.scaleFactor)),
                                        int(ceil(106 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # upper center (8) up
                          pygame.K_RETURN: (int(floor(210 * const.scaleFactor)),
                                            int(ceil(143 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # middle center(5) action
                          pygame.K_DOWN: (int(floor(210 * const.scaleFactor)),
                                          1 + int(ceil(180 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # lower center (2) down *
                          pygame.K_i: (int(ceil(247 * const.scaleFactor)),
                                       int(ceil(106 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # upper right  (9) item *
                          pygame.K_RIGHT: (int(ceil(247 * const.scaleFactor)),
                                           int(ceil(143 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # middle right (6) right *
                          pygame.K_s: (int(ceil(247 * const.scaleFactor)),
                                       1 + int(ceil(180 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # lower right  (3) hero stats *

                          pygame.K_a: (int(floor(135 * const.scaleFactor)),
                                       int(ceil(143 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # armor
                          pygame.K_w: (int(floor(135 * const.scaleFactor)),
                                       int(ceil(180 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor))),
                          # weapons

                          pygame.K_h: (int(floor(78 * const.scaleFactor)),
                                       int(ceil(143 * const.scaleFactor)) + int(ceil(300 * const.scaleFactor)))  # help
    ...
    def scrollFromCenter(self, screenOne, screenTwo):
        ...
        for i in range(0, int(screenTwo.get_width() / 2), 5):
